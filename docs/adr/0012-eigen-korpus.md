...
- **Das Format ist festgelegt, nicht verhandelbar.** 22050 Hz mono PCM16 ist die Bedingung dafür, dass eigene Aufnahmen mit dem Störgeräusch-Overlay kombinierbar bleiben. Liefert `AudioRecord` auf einem Gerät diese Rate nicht, ist das ein echtes Problem und kein Detail — vor der Umsetzung zu prüfen.
